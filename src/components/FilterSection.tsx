      ...
      <div className="flex flex-wrap gap-4 items-end">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select 
              className="px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-[12px] text-slate-700 outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 cursor-pointer transition-all"
